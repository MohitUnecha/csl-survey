...
router.get('/stats', async (req, res) => {
  try {
    ...
    const [
      ...
      capBuildCounts, learningCounts, roleCounts, cohortCounts, ambassadorCounts,
      ...
      countGroupBy(where, args, 'prompt_academy_cohort'),
      countGroupBy(where, args, 'ambassador_interest'),
    ...
    res.json({
      ...
      roleCounts, cohortCounts, ambassadorCounts,
      motivatorCounts,
      discoveryCounts,
      barrierCounts,
      toolCounts,
...
router.get('/export', async (req, res) => {
  try {
    ...
    const data = result.rows.map(row => ({
      ...
      'Prompt Academy Cohort': row.prompt_academy_cohort,
      ...
      'Ambassador Interest': row.ambassador_interest,
